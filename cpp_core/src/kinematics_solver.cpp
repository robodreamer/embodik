...
KinematicsSolver::capture_position_step_mutable_state() const {
  ...
  snapshot.health_sampling_tick = health_sampling_tick_;
  snapshot.health_sampling_cache_valid = health_sampling_cache_valid_;
  snapshot.health_sampling_cache_q = health_sampling_cache_q_;
  snapshot.health_sampling_cache_score = health_sampling_cache_score_;
  ...
  snapshot.collision_stuck_last_distances =
      collision_stuck_last_distances_;
  return snapshot;
}
...
void KinematicsSolver::restore_position_step_mutable_state(
  ...
  health_sampling_tick_ = snapshot.health_sampling_tick;
  health_sampling_cache_valid_ = snapshot.health_sampling_cache_valid;
  health_sampling_cache_q_ = snapshot.health_sampling_cache_q;
  health_sampling_cache_score_ = snapshot.health_sampling_cache_score;
