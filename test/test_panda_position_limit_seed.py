"""Panda: one position IK step from a seed on a joint upper limit vs. HMND-style nudge.

Mirrors the hmnd_robot regression ``embodik_position_limit_seed_test`` (pendulum URDF)
...
See also: ``hmnd_robot/.../tests/embodik_position_limit_seed_test.py``.
"""
...
def _nudge_joint_positions_inside_limits(
    ...
    """Same semantics as hmnd_robots.embodik_helpers.limits.nudge_joint_positions_inside_limits."""
