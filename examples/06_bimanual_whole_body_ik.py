...
``robot_descriptions``. The shared GUI exposes left/right tool gizmos plus an
optional torso gizmo, a torso policy dropdown, and a soft
torso-contribution slider for both robot families.
