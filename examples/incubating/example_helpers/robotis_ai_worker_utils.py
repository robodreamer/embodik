...
def resolve_ffw_urdf_path(variant: str) -> Path:
    ...
    candidates = {
        "sg2": [
            Path("/home/andypark/Projects/robot_models_urdf/ffw_sg2_mobile_robot/ffw_sg2_mobile_robot.urdf"),
        ],
        "bg2": [
            Path("/home/andypark/Projects/robot_models_urdf/ffw_bg2_mobile_robot/ffw_bg2_mobile_robot.urdf"),
        ],
    }
