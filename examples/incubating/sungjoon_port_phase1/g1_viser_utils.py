#!/usr/bin/env python3
"""Shared helpers for g1 Unitree G1 Viser ports.
...
def resolve_g1_urdf_path() -> Path:
    ...
    candidates = [
        Path("/path/to/local/Projects/repos/robot-model-repos/unitree_ros/robots/g1_description/g1_29dof_rev_1_0_with_inspire_hand_FTP.urdf"),
        Path("/path/to/local/Projects/repos/robot-model-repos/unitree_ros/robots/g1_description/g1_29dof_rev_1_0.urdf"),
        Path("/path/to/local/Projects/repos/robot-model-repos/unitree_ros/robots/g1_description/g1_29dof.urdf"),
    ]
