# Unitree G1 Phase1 Ports (Sungjoon -> EmbodiK)

These scripts are **behavioral counterparts** of the original Sungjoon notebooks,
adapted to EmbodiK-style Viser examples (not literal notebook ports).

## Parity Matrix

| Sungjoon source notebook | EmbodiK phase1 script | Parity focus |
|---|---|---|
...
| collision/contact exploration flows in Sungjoon G1 notebooks | `06_g1_collision_constraint_counterpart_viser.py` | collision distance constraint tuning + closest-pair diagnostics |
...
- Keep both interaction styles available:
  - Sungjoon-style 3-point goal mode
