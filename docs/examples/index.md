...
- [`incubating/sungjoon_port_phase1/README.md`](../../examples/incubating/sungjoon_port_phase1/README.md) — Behavior-parity matrix and porting intent
- [`incubating/sungjoon_port_phase1/04_g1_ik_site_counterpart_viser.py`](../../examples/incubating/sungjoon_port_phase1/04_g1_ik_site_counterpart_viser.py) — Dual-mode site IK (`Sungjoon 3-point` vs `EmbodiK 6D`) with retargeting presets
- [`incubating/sungjoon_port_phase1/05_g1_base_ik_counterpart_viser.py`](../../examples/incubating/sungjoon_port_phase1/05_g1_base_ik_counterpart_viser.py) — Floating-base full-body IK with 6D feet mode, CoM polygon controls, and retargeting presets
- [`incubating/sungjoon_port_phase1/06_g1_collision_constraint_counterpart_viser.py`](../../examples/incubating/sungjoon_port_phase1/06_g1_collision_constraint_counterpart_viser.py) — Collision-constrained IK with arm-only mode and closest-pair diagnostics
- [`incubating/sungjoon_port_phase1/07_g1_dual_hand_grounded_com_viser.py`](../../examples/incubating/sungjoon_port_phase1/07_g1_dual_hand_grounded_com_viser.py) — Reimagined G1 demo: grounded floating base, dual-hand 6D gizmos, CoM support-polygon constraint, and solver-native tight feet epsilon-box constraints
